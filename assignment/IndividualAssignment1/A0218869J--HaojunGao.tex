...
\PY{k}{def} \PY{n+nf}{histograms}\PY{p}{(}\PY{n}{sample\PYZus{}mean\PYZus{}lst}\PY{p}{,} \PY{n}{sample\PYZus{}var\PYZus{}lst}\PY{p}{,} \PY{n}{pop\PYZus{}mean}\PY{p}{,} \PY{n}{pop\PYZus{}sd}\PY{p}{,} \PY{n}{sample\PYZus{}size}\PY{p}{,} \PY{n}{is\PYZus{}distribution}\PY{o}{=}\PY{k+kc}{True}\PY{p}{,} 
               \PY{n}{num\PYZus{}bins} \PY{o}{=} \PY{l+m+mi}{50}\PY{p}{,} \PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{14}\PY{p}{,} \PY{l+m+mi}{5}\PY{p}{)}\PY{p}{)}\PY{p}{:}
...
\PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Theoretical standard deviation of the sample variance: }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{sqrt}\PY{p}{(}\PY{p}{(}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{pop\PYZus{}sd}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{4}\PY{p}{)}\PY{o}{/}\PY{p}{(}\PY{n}{sample\PYZus{}size} \PY{o}{\PYZhy{}} \PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)}\PY{p}{)}\PY{p}{)}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k}{def} \PY{n+nf}{plot\PYZus{}k}\PY{p}{(}\PY{n}{mse\PYZus{}test}\PY{p}{,} \PY{n}{mse\PYZus{}train} \PY{o}{=} \PY{k+kc}{False}\PY{p}{)}\PY{p}{:}
    \PY{n}{fig} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{12}\PY{p}{,} \PY{l+m+mi}{6}\PY{p}{)}\PY{p}{)}
    \PY{n}{plt}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{mse\PYZus{}test}\PY{p}{,}  \PY{n}{color} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{red}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{n}{marker} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{.}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{markersize} \PY{o}{=} \PY{l+m+mi}{8}\PY{p}{,} 
                 \PY{n}{markeredgecolor} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{black}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{markerfacecolor} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{black}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{label} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Test MSE}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
    \PY{k}{if} \PY{n}{mse\PYZus{}train}\PY{p}{:}
        \PY{n}{plt}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{mse\PYZus{}train}\PY{p}{,}  \PY{n}{color} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{blue}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{marker} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{.}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{markersize} \PY{o}{=} \PY{l+m+mi}{8}\PY{p}{,} 
             \PY{n}{markeredgecolor} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{black}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{markerfacecolor} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{black}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{n}{label} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Train MSE}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
    \PY{n}{plt}\PY{o}{.}\PY{n}{legend}\PY{p}{(}\PY{p}{)}
    \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{MSE with different K}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
    \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k}{def} \PY{n+nf}{train\PYZus{}model}\PY{p}{(}\PY{n}{train\PYZus{}x}\PY{p}{,} \PY{n}{test\PYZus{}x}\PY{p}{,} \PY{n}{y}\PY{p}{,} \PY{n}{y\PYZus{}test}\PY{p}{,} \PY{n}{is\PYZus{}print} \PY{o}{=} \PY{k+kc}{True}\PY{p}{,} \PY{n}{is\PYZus{}plot} \PY{o}{=} \PY{k+kc}{False}\PY{p}{)}\PY{p}{:}
    \PY{n}{k} \PY{o}{=} \PY{l+m+mi}{0}
    \PY{c+c1}{\PYZsh{} Initialize}
    \PY{c+c1}{\PYZsh{} Parameter \PYZsq{}not\PYZus{}improve\PYZsq{}: training will stop when performance is not improved for 10 rounds}
    \PY{n}{optimal\PYZus{}mse}\PY{p}{,} \PY{n}{currenct\PYZus{}mse}\PY{p}{,} \PY{n}{not\PYZus{}improve} \PY{o}{=} \PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{0}
    \PY{n}{mse\PYZus{}lst\PYZus{}train}\PY{p}{,} \PY{n}{mse\PYZus{}lst\PYZus{}test} \PY{o}{=} \PY{p}{[}\PY{p}{]}\PY{p}{,} \PY{p}{[}\PY{p}{]}
    \PY{k}{while} \PY{n}{not\PYZus{}improve} \PY{o}{\PYZlt{}} \PY{l+m+mi}{10}\PY{p}{:}
        ...
        \PY{n}{knn}\PY{o}{.}\PY{n}{fit}\PY{p}{(}\PY{n}{train\PYZus{}x}\PY{p}{,} \PY{n}{y}\PY{p}{)}
        \PY{n}{mse\PYZus{}lst\PYZus{}test}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{mse}\PY{p}{(}\PY{n}{y\PYZus{}test}\PY{p}{,} \PY{n}{knn}\PY{o}{.}\PY{n}{predict}\PY{p}{(}\PY{n}{test\PYZus{}x}\PY{p}{)}\PY{p}{)}\PY{p}{)}
        \PY{n}{mse\PYZus{}lst\PYZus{}train}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{mse}\PY{p}{(}\PY{n}{y}\PY{p}{,} \PY{n}{knn}\PY{o}{.}\PY{n}{predict}\PY{p}{(}\PY{n}{train\PYZus{}x}\PY{p}{)}\PY{p}{)}\PY{p}{)}
        \PY{n}{currenct\PYZus{}mse} \PY{o}{=} \PY{n}{mse\PYZus{}lst\PYZus{}test}\PY{p}{[}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]}
        \PY{k}{if} \PY{n}{currenct\PYZus{}mse} \PY{o}{\PYZlt{}}\PY{o}{=} \PY{n}{optimal\PYZus{}mse} \PY{o+ow}{or} \PY{n}{optimal\PYZus{}mse} \PY{o}{==} \PY{l+m+mi}{0}\PY{p}{:}
            \PY{n}{optimal\PYZus{}mse} \PY{o}{=} \PY{n}{currenct\PYZus{}mse}
            \PY{n}{not\PYZus{}improve} \PY{o}{=} \PY{l+m+mi}{0}
        \PY{k}{else}\PY{p}{:}
            \PY{n}{not\PYZus{}improve} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}
    ...
    \PY{k}{if} \PY{n}{is\PYZus{}print}\PY{p}{:} \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Performance is not improved for 10 rounds.}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
    \PY{k}{if} \PY{n}{is\PYZus{}plot}\PY{p}{:} \PY{n}{plot\PYZus{}k}\PY{p}{(}\PY{n}{mse\PYZus{}lst\PYZus{}test}\PY{p}{,} \PY{n}{mse\PYZus{}lst\PYZus{}train}\PY{p}{)}
    \PY{k}{return} \PY{n}{k} \PY{o}{\PYZhy{}} \PY{n}{not\PYZus{}improve}\PY{p}{,} \PY{n}{optimal\PYZus{}mse}
\end{Verbatim}
\end{tcolorbox}
...
\PY{n}{k}\PY{p}{,} \PY{n}{optimal\PYZus{}mse} \PY{o}{=} \PY{n}{train\PYZus{}model}\PY{p}{(}\PY{n}{train\PYZus{}x}\PY{p}{,} \PY{n}{test\PYZus{}x}\PY{p}{,} \PY{n}{y}\PY{p}{,} \PY{n}{y\PYZus{}test}\PY{p}{,} \PY{n}{is\PYZus{}plot} \PY{o}{=} \PY{k+kc}{True}\PY{p}{)}
...
Performance is not improved for 10 rounds.
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{A0218869J--HaojunGao_files/A0218869J--HaojunGao_17_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k}{def} \PY{n+nf}{plot\PYZus{}rounds}\PY{p}{(}\PY{n}{optimal\PYZus{}mse\PYZus{}lst}\PY{p}{)}\PY{p}{:}
    \PY{n}{fig} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{12}\PY{p}{,} \PY{l+m+mi}{6}\PY{p}{)}\PY{p}{)}
    \PY{n}{x} \PY{o}{=} \PY{p}{[}\PY{n+nb}{str}\PY{p}{(}\PY{n}{i}\PY{p}{)} \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{optimal\PYZus{}mse\PYZus{}lst}\PY{p}{)}\PY{p}{)}\PY{p}{]}
    \PY{n}{plt}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{n}{optimal\PYZus{}mse\PYZus{}lst}\PY{p}{,}  \PY{n}{color} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{red}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{n}{marker} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{.}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{markersize} \PY{o}{=} \PY{l+m+mi}{8}\PY{p}{,} 
             \PY{n}{markeredgecolor} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{black}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{markerfacecolor} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{black}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{label} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Test MSE}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
    \PY{n}{plt}\PY{o}{.}\PY{n}{legend}\PY{p}{(}\PY{p}{)}
    \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{MSE with Different Number of Redundant Columns}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
    \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{optimal\PYZus{}mse\PYZus{}lst} \PY{o}{=} \PY{p}{[}\PY{p}{]}
\PY{k}{for} \PY{n}{j} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{z}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)} \PY{o}{+} \PY{l+m+mi}{1}\PY{p}{)}\PY{p}{:}
    ...
    \PY{n}{optimal\PYZus{}mse\PYZus{}lst}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{optimal\PYZus{}mse}\PY{p}{)}
    \PY{n+nb}{print}\PY{p}{(}
...
\PY{n}{plot\PYZus{}rounds}\PY{p}{(}\PY{n}{optimal\PYZus{}mse\PYZus{}lst}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
Add first 20 columns     Optimal k: 5    Test MSE: 29.643836178903474
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{A0218869J--HaojunGao_files/A0218869J--HaojunGao_24_1.png}
    \end{center}
    { \hspace*{\fill} \\}
